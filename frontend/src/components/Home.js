...
export default function Home() {
  return (
    <section className="mx-auto pb-5" style={{width: 80 + '%'}}>
      ...
      <p>We are your one-stop destination for all your university needs. 
                    Whether you're looking to secure a convenient parking permit, borrow a textbook for your subject, 
                    or apply for your student ID card, we've got you covered. Have a look at our various services here</p>
      <div className="row">
        <div className="col-sm-4 mt-5">
            <div className="card">
            <img className="card-img-top" src={parkingimage} alt="Cars parking"></img>
        ...
        <div className="col-sm-4 mt-5">
            <div className="card">
            <img className="card-img-top" src={idimage} alt="Student holding id card"></img>
            <div className="card-body">
                <h5 className="card-title">ID Card</h5>
                <p className="card-text">Get your student id card here</p>
                <Link to="/id-card" className="btn btn-primary">Apply</Link>
            </div>
            </div>
        </div>
        <div className="col-sm-4 mt-5">
            <div className="card">
            <img className="card-img-top" src={roomimage} alt="Students studying together"></img>
            <div className="card-body">
